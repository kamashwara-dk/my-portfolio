...
// Inline SVG icons for social links — styled for dark background
const LinkedInIcon = () => (
  <svg
...
const Footer = () => {
  ...
  return (
    <footer
      className={cn(
        styles.paddingX,
        "w-full flex items-center py-8 bg-primary border-t border-t-secondary/10 relative z-10"
      )}
    >
      <div className="w-full flex flex-col sm:flex-row justify-between items-center max-w-7xl mx-auto gap-4">
        <p className="text-secondary text-sm sm:text-base font-medium">
          &copy; {new Date().getFullYear()} Kamashwara D K. All rights reserved.
        </p>
